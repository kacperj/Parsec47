...
alias SDL_blit = extern(C) int function(SDL_Surface *src, SDL_Rect *srcrect,
...
{
	return SDL_LoadBMP_RW(SDL_RWFromFile(file, cast(char*)"rb"), 1);
}
...
{
	return SDL_SaveBMP_RW(surface, SDL_RWFromFile(file, cast(char*)"wb"), 1);
}
